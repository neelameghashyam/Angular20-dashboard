...
describe('NavbarMobileSubmenuComponent', () => {
  ...
  describe('closeMobileMenu', () => {
    ...
    it('should set showMobileMenu to false when true', () => {
      mockMenuService.showMobileMenu = true;
      component.closeMobileMenu();
      expect(mockMenuService.showMobileMenu).toBe(false);
    });

    it('should set showMobileMenu to false when already false', () => {
  ...
  describe('collapse (private method)', () => {
    it('should collapse all items and their children', () => {
      ...
      // Use TypeScript type assertion to access private method
